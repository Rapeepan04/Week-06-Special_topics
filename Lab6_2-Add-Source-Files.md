...
- จำนวนไฟล์ source: 2
- ขนาด binary: 118 KB
- การทำงาน: อ่านค่าอุณหภูมิและความชื้นจาก sensor แล้วพิมพ์ออกผ่าน serial log (ยังไม่มีการแสดงผลบนจอ)

**ขั้นตอนที่ 2 (เพิ่ม display.c):**
- จำนวนไฟล์ source: 3
- ขนาด binary: 131 KB
- การทำงาน: การล้างหน้าจอ, แสดงข้อความ และค่าต่าง ๆ

**ขั้นตอนที่ 3 (เพิ่ม led.c):**
- จำนวนไฟล์ source: 4
- ขนาด binary: 131 KB
- การทำงาน:เพิ่มฟังก์ชันควบคุม LED: เปิด ปิด และ toggle ตามลูปของโปรแกรม
